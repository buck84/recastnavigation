...
public:
	...
	void reset(class rcContext* ctx);
	...
	int writeFileVertical(FILE* fp);
	int writeMeshVertical(FILE* fp, MeshObj& m);
	
	/// Method to return static mesh data.
	//const rcMeshLoaderObj* getMesh() const { return m_mesh; }
	bool meshInited() { return m_meshes.size() > 0; }
	...
	std::vector<MeshObj>& getMeshObjs() { return m_meshes; }
